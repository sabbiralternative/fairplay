          ...
          <div id="pills-tabContent" className="tab-content">
            ...
            >
              <div className="tab-content-innter">
                <Banner />
                <NewCasinoThumbnails />
                <div className="row ex_slide mx-0">
                  <div className="col-md-12 px-1">
                    <a
                      target="_blank"
                      className="dontaccount"
                      href="https://wa.link/fairplayonee"
                    >
                      <span>If you do not have an account please contact</span>
                      <svg
                        width="35px"
                        height="35px"
                        viewBox="0 0 32 32"
                ...
                <div className="inplay-main">
                  ...
                  <div className="premium-banner mb-3">
                    <img
                      src="assets/img/Banner/premium-new.gif"
                      className="img-fluid"
                    />
                  </div>

                  <div className="live-card-banner mt-4">
                    <div className="row">
                      <div className="col-md-6 mb-2 mb-md-0">
                        <img
                          src="assets/img/Banner/live-cards-banner.gif"
                          className="img-fluid"
                        />
                      </div>
                      <div className="col-md-6">
                        <img
                          src="assets/img/Banner/live-casino-banner.gif"
                          className="img-fluid"
                        />
                      </div>
                    </div>
